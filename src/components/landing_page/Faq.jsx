...
export default function Faq() {
  return (
    <div className={styles.termsContainer}>
      ...
      <p>
        SimpleHostel is currently offered as a free service in its first stage.
        This allows you to access essential hostel management tools at no cost.
        In future updates, we may introduce additional paid features, such as
        integrations with booking channels like Booking.com and Hostelworld.
      </p>
      ...
      <p>
        ...
        industry practices to protect your information and regularly update our
        security measures. Please review our{" "}
      ...
      <p>
        ...
        includes integrations with popular booking platforms to streamline your
