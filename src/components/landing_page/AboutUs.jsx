  ...
  return (
    <div className={styles.termsContainer}>
      ...
      <p>
        ...
        unforgettable experience for guests. With a user-friendly platform and a
        range of practical tools, SimpleHostel provides an intuitive way to
      ...
      <p>
        ...
        resources. That&apos;s why SimpleHostel is designed to streamline daily
        operations, enhance productivity, and foster better decision-making for
        hostel-staff.
      </p>
      ...
      offers a free, robust platform tailored to hostel management needs in its
      first stage.By focusing on the core essential -- reservations, calendar
      views, room and rate management, and user management -- SimpleHostel
      provides exactly what you need to keep things running smoothly.
      <br />
      In the future, we look forwards to evolving with the need of our users. We
      plan to expand SimpleHostel&apos; features, offering additional
      ...
      <br />
      Thank you for choosing SimpleHostel. We&apos;re excited to be part of your
      journey in creating memorable guest experiences!
    </div>
  );
}
